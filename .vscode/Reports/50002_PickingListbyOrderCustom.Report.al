report 50002 "Picking List by Order Custom"
{
    DefaultLayout = RDLC;
    RDLCLayout = './.vscode/ReportLayout/PickingListbyOrderCustom.rdl';
    ...
    dataset
    {
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(LocationLoop; "Integer")
            {
                ...
                dataitem(CopyNo; "Integer")
                {
                    ...
                    dataitem(PageLoop; "Integer")
                    {
                        ...
                        //jay 18/01/24 ++
                        column(Sales_Header___Sell_to_Customer_Name__; "Sales Header"."Sell-to Customer Name")
                        {
                        ...
                        column(Sales_Header___YourReference; "Sales Header"."Your Reference")
                        {

                        }
                        column(Sales_Header___RequestedShipDate; "Sales Header"."Request Ship Date")
                        {

                        }
                        column(Sales_Header___LoctionCode; "Sales Header"."Location Code")
                        {

                        }
                        column(Sales_Header___ShipmentMethodCode; "Sales Header"."Shipment Method Code")
                        {

                        }
                        column(Sales_Header___AgentShipmentCode; "Sales Header"."Shipping Agent Code")
                        {

                        }
                        column(Sales_Header___ShippingAgentService; "Sales Header"."Shipping Agent Service Code")
                        {
                        ...
                        "Sales Line")
                        {
                            ...
                            begin
                                ...
                                if Item."Item Tracking Code" <> '' then begin
                                    ...
                                    TrackSpec2.SetRange(TrackSpec2."Source Type", DATABASE::"Sales Line");
                                    TrackSpec2.SetRange(TrackSpec2."Source Subtype", "Sales Line"."Document Type");
                                    TrackSpec2.SetRange(TrackSpec2."Source ID", "Sales Line"."Document No.");
                                    TrackSpec2.SetRange(TrackSpec2."Source Ref. No.", "Sales Line"."Line No.");
                                ...
                                PackageCount := 0;
                                //"Sales Line".CalcFields("Reserved Qty. (Base)");  mbr 4/12/24 - we will use  Quantity Base instead
            ...
            begin
                ...
                //FormatAddress.SalesHeaderBillTo(Address, "Sales Header");  - we need this to be Ship From
                If "Sales Header"."Location Code" <> '' then begin
                    GetLocation.RESET;
                    ...
                    repeat
                        ...
                        if ItemUnitofMeasure_lRec.FindFirst() then begin
                            IF ItemUnitofMeasure_lRec."Qty. per Unit of Measure" > 0 then
                                getPackageCount := SalesLine."Quantity (Base)" / ItemUnitofMeasure_lRec."Qty. per Unit of Measure";
                        end;
