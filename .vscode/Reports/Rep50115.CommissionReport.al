report 50115 "Commission Report"
{
    ...
    begin
        ...
        // CBGLE.SetRange("Document No.", 'PS-INV109371');  //mbr test - for testing purposes only
            ...
            repeat
                ...
                If SalesInvHdr.FindFirst() then begin
                    ...
                    IF SalesInvHdr."Invoice Discount Value" > 0 then begin
                        ...
                        InsTmpCommission.PaidAmount := 0;
                        InsTmpCommission.CMAmount := SalesInvHdr."Invoice Discount Value";
                        InsTmpCommission.ItemNo := 'DISC';
                        InsTmpCommission.ItemSort := 1;
                        InsTmpCommission.Qty := 0;
                        InsTmpCommission.UserID := UserId;
                        InsTmpCommission.AppliedDocNo := GetSumCommission.AppliedDocNo;
        ...
        IF GetSumCommission.FindSet() then
            repeat
                ...
                if GetAmount > 0 then begin
                    ...
                    InsTmpCommission.OriginalAmount := 0;
                    InsTmpCommission.PaidAmount := 0;
                    InsTmpCommission.CMAmount := GetAmount;
