report 50108 BOLDetailedReport
{
    DefaultLayout = RDLC;
    RDLCLayout = './.vscode/ReportLayout/BOLDetailedReport.rdl';
    Caption = 'Bill of Lading Detail';
    ...
    dataset
    {
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                column(DetailLinePckg; DetailLinePckg)
                {

                }
                column(LineWeight; LineWeight)
                {
                ...
                begin
                    ...
                    "Sales Line".CalcFields("M-Pack Qty", "M-Pack Weight");
                    IF "Sales Line"."M-Pack Qty" > 0 then begin
                        IF ("Sales Line"."Quantity (Base)" MOD "Sales Line"."M-Pack Qty") > 0 then
                            DetailLinePckg := ("Sales Line"."Quantity (Base)" DIV "Sales Line"."M-Pack Qty") + 1
                        ELSE
                            DetailLinePckg := ("Sales Line"."Quantity (Base)" / "Sales Line"."M-Pack Qty");
                        LineWeight := DetailLinePckg * "Sales Line"."M-Pack Weight";
                    end;
