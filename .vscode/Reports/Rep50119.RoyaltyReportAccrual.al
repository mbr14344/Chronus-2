report 50119 RoyaltyReportAccrual
{
    ApplicationArea = All;
    Caption = 'Royalty Detailed Report - Accrual';
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;

    RDLCLayout = './.vscode/ReportLayout/RoyalyDetailedReportAccrual.rdl';
    ...
    var
        ...
        lblReportTitle: Label 'Royalty Detail Report - Accrual Sales by Item';
                ...
                If SalesInvLn.FindSet() then
                    repeat
                        ...
                        IF TmpRoyalty.FindFirst() then begin
                            ...
                            TmpRoyalty.ReturnedAmount += GetReturnedAmt;
