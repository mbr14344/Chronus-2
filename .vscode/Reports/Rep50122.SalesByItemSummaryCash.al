report 50122 "Sales By Item Summary - Cash"
{
    ApplicationArea = All;
    Caption = 'Sales By Item Summary Report - Real Time';
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;

    RDLCLayout = './.vscode/ReportLayout/SalesByItemSummaryCash.rdl';
    ...
    dataset
    {
        ...
        dataitem(TmpRoyalty; TmpRoyalty)
        {
            ...
            trigger OnAfterGetRecord()
            begin
                //if ((TmpRoyalty.DatePaid < StartDate) and (StartDate <> 0D)) or ((TmpRoyalty.DatePaid > EndDate) and (EndDate <> 0D)) then begin
                //     CurrReport.Skip();
                //  end
            end;
