report 50004 CustomCheckNoStub
{
    DefaultLayout = RDLC;
    RDLCLayout = './.vscode/ReportLayout/CustomCheckNoStub.rdlc';
    Caption = 'Check No Stub';
        ...
        dataitem(GenJnlLine; "Gen. Journal Line")
        {
            ...
            dataitem(CheckPages; "Integer")
            {
                ...
                dataitem(PrintCheck; "Integer")
                {
                    ...
                    column(CheckAmtTxt; CheckAmountText)
                    {
                    }
                    ...
                    begin
                        if not TestPrint then begin
                            ...
                            if FoundLast and AddedRemainingAmount then    //MBR 4/2/24 - INSERT ONLY IF NOT VOIDED
                            ...
                            if bCLEInit = false then  //MBR 4/2/24 - we only want to record once.
                                begin
                                bCLEInit := true;
                ...
                begin
                    ...
                    //MBR 4/2/24 - only increment Check No once as we are only going to print 1 check and no check stub
