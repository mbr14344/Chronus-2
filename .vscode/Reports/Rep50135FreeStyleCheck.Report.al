report 50135 "FS Check (Check/Stub/Stub)"
{
    DefaultLayout = RDLC;
    RDLCLayout = './.vscode/ReportLayout/FreestyleCheck_CheckStubStub.rdl';
    Caption = 'Freestyle Check (Check/Stub/Stub)';
    Permissions = TableData "Bank Account" = m;
    //MBR 1/19/24 - customize check sub sub
    dataset
    {
        ...
        dataitem(GenJnlLine; "Gen. Journal Line")
        {
            ...
            dataitem(CheckPages; "Integer")
            {
                ...
                column(CheckToAddr_1_; TmpTable.Name)
                {
                }
                ...
                dataitem(PrintSettledLoop; "Integer")
                {
                    ...
                    column(GetRemainingAmount; GetRemainingAmount)
                    {
                        AutoFormatExpression = GenJnlLine."Currency Code";
                        AutoFormatType = 1;
                    }
                    ...
                    column(CheckDateDt; CheckDateDt)
                    {
                    ...
                    begin
                        ...
                        Stub2LineOriginalAmount[Stub2LineNo] := OriginalAmount;
                        Stub2LineDiscount[Stub2LineNo] := LineDiscount;
                        Stub2PostingDesc[Stub2LineNo] := PostingDesc;
                        Stub2Type[Stub2LineNo] := Format(TypeText);
                        Stub2LineGetRemainingAmount[Stub2LineNo] := GetRemainingAmount;
                    end;
                ...
                dataitem(PrintCheck; "Integer")
                {
                    ...
                    column(Stub2LineOriginalAmount_1_; Stub2LineOriginalAmount[1])
                    {
                        AutoFormatExpression = GenJnlLine."Currency Code";
                        AutoFormatType = 1;
                    }
                    column(Stub2LineOriginalAmount_2_; Stub2LineOriginalAmount[2])
                    {
                        AutoFormatExpression = GenJnlLine."Currency Code";
                        AutoFormatType = 1;
                    }
                    column(Stub2LineOriginalAmount_3_; Stub2LineOriginalAmount[3])
                    {
                        AutoFormatExpression = GenJnlLine."Currency Code";
                        AutoFormatType = 1;
                    }
                    column(Stub2LineOriginalAmount_4_; Stub2LineOriginalAmount[4])
                    {
                        AutoFormatExpression = GenJnlLine."Currency Code";
                        AutoFormatType = 1;
                    }
                    column(Stub2LineOriginalAmount_5_; Stub2LineOriginalAmount[5])
                    {
                        AutoFormatExpression = GenJnlLine."Currency Code";
                        AutoFormatType = 1;
                    }
                    column(Stub2LineOriginalAmount_6_; Stub2LineOriginalAmount[6])
                    {
                        AutoFormatExpression = GenJnlLine."Currency Code";
                        AutoFormatType = 1;
                    }
                    column(Stub2LineOriginalAmount_7_; Stub2LineOriginalAmount[7])
                    {
                        AutoFormatExpression = GenJnlLine."Currency Code";
                        AutoFormatType = 1;
                    }
                    column(Stub2LineOriginalAmount_8_; Stub2LineOriginalAmount[8])
                    {
                        AutoFormatExpression = GenJnlLine."Currency Code";
                        AutoFormatType = 1;
                    }
                    column(Stub2LineOriginalAmount_9_; Stub2LineOriginalAmount[9])
                    {
                        AutoFormatExpression = GenJnlLine."Currency Code";
                        AutoFormatType = 1;
                    }
                    column(Stub2LineOriginalAmount_10_; Stub2LineOriginalAmount[10])
                    {
                        AutoFormatExpression = GenJnlLine."Currency Code";
                        AutoFormatType = 1;
                    }
                    column(Stub2LineGetRemainingAmount_1_; Stub2LineGetRemainingAmount[1])
                    {
                        AutoFormatExpression = GenJnlLine."Currency Code";
                        AutoFormatType = 1;
                    }
                    column(Stub2LineGetRemainingAmount_2_; Stub2LineGetRemainingAmount[2])
                    {
                        AutoFormatExpression = GenJnlLine."Currency Code";
                        AutoFormatType = 1;
                    }
                    column(Stub2LineGetRemainingAmount_3_; Stub2LineGetRemainingAmount[3])
                    {
                        AutoFormatExpression = GenJnlLine."Currency Code";
                        AutoFormatType = 1;
                    }
                    column(Stub2LineGetRemainingAmount_4_; Stub2LineGetRemainingAmount[4])
                    {
                        AutoFormatExpression = GenJnlLine."Currency Code";
                        AutoFormatType = 1;
                    }
                    column(Stub2LineGetRemainingAmount_5_; Stub2LineGetRemainingAmount[5])
                    {
                        AutoFormatExpression = GenJnlLine."Currency Code";
                        AutoFormatType = 1;
                    }
                    column(Stub2LineGetRemainingAmount_6_; Stub2LineGetRemainingAmount[6])
                    {
                        AutoFormatExpression = GenJnlLine."Currency Code";
                        AutoFormatType = 1;
                    }
                    column(Stub2LineGetRemainingAmount_7_; Stub2LineGetRemainingAmount[7])
                    {
                        AutoFormatExpression = GenJnlLine."Currency Code";
                        AutoFormatType = 1;
                    }
                    column(Stub2LineGetRemainingAmount_8_; Stub2LineGetRemainingAmount[8])
                    {
                        AutoFormatExpression = GenJnlLine."Currency Code";
                        AutoFormatType = 1;
                    }
                    column(Stub2LineGetRemainingAmount_9_; Stub2LineGetRemainingAmount[9])
                    {
                        AutoFormatExpression = GenJnlLine."Currency Code";
                        AutoFormatType = 1;
                    }
                    column(Stub2LineGetRemainingAmount_10_; Stub2LineGetRemainingAmount[10])
                    {
                        AutoFormatExpression = GenJnlLine."Currency Code";
                        AutoFormatType = 1;
                    }
                    ...
                    column(Stub2Type_1_; Stub2Type[1])
                    {
                        //AutoFormatExpression = GenJnlLine."Source Type";
                        AutoFormatType = 1;
                    }
                    column(Stub2Type_2_; Stub2Type[2])
                    {
                    }
                    column(Stub2Type_3_; Stub2Type[3])
                    {
                    }
                    column(Stub2Type_4_; Stub2Type[4])
                    {
                    }
                    column(Stub2Type_5_; Stub2Type[5])
                    {
                    }
                    column(Stub2Type_6_; Stub2Type[6])
                    {
                    }
                    column(Stub2Type_7_; Stub2Type[7])
                    {
                    }
                    column(Stub2Type_8_; Stub2Type[8])
                    {
                    }
                    column(Stub2Type_9_; Stub2Type[9])
                    {
                    }
                    column(Stub2Type_10_; Stub2Type[10])
                    {
                    }
                    ...
                    Column(TotalRemainingAmount; TotalLineAmount + TotalLineDiscount)
                    {
                ...
                begin
                    ...
                    Clear(Stub2Type);
                    Clear(Stub2LineOriginalAmount);
                    Clear(Stub2LineGetRemainingAmount);
                    Stub2DocNoHeader := '';
                    Stub2DocDateHeader := '';
                    Stub2AmountHeader := '';
                    Stub2DiscountHeader := '';
                    ...
                    case BalancingType of
                        BalancingType::"G/L Account":
                            begin
                                ...
                                FormatAddr.FormatAddr(CheckToAddr, TmpTable.Name, '', '', TmpTable.Address, '', TmpTable.City, TmpTable.PostalCode, TmpTable.State, TmpTable."Country/Region Code");
                        ...
                        BalancingType::Vendor:
                            begin
                                ...
                                //MBR 12/18/24 - new version VendorRemitToAddress needs to have RemitAddress as first parameter and Array[8] as 2nd param
    ...
    begin
        ...
        if not GenJnlTemplate."Force Doc. Balance" then
            if not Confirm(USText001Qst, true) then
                Error(USText002Err);
        VoidGenJnlLine.Comment := description;
        VoidGenJnlLine.Modify();
        PageNo := 0;
    end;
    ...
    var
        ...
        Stub2LineOriginalAmount: array[50] of Decimal;
        Stub2LineGetRemainingAmount: array[50] of Decimal;
        Stub2LineDiscount: array[50] of Decimal;

        Stub2PostingDesc: array[50] of Text[100];
        Stub2Type: array[50] of Text[30];
    ...
    begin
        ...
        CheckDateDt := CustLedgEntry2."Posting Date";
        CurrencyCode2 := CustLedgEntry2."Currency Code";
        CustLedgEntry2.CalcFields("Remaining Amount");
        CustLedgEntry2.CalcFields("Original Amount");

        OriginalAmount := ABS(CustLedgEntry2."Original Amount");
        OriginalAmount := Round(
                    ExchangeAmt(CustLedgEntry2."Posting Date", CurrencyCode2, GenJnlLine."Currency Code",
                      OriginalAmount), Currency."Amount Rounding Precision");
        GetRemainingAmount := ABS(CustLedgEntry2."Remaining Amount");
        GetRemainingAmount := Round(
                    ExchangeAmt(CustLedgEntry2."Posting Date", CurrencyCode2, GenJnlLine."Currency Code",
                      GetRemainingAmount), Currency."Amount Rounding Precision");
    ...
    begin
        ...
        CheckDateDt := VendLedgEntry2."Posting Date";
        CurrencyCode2 := VendLedgEntry2."Currency Code";
        VendLedgEntry2.CalcFields("Remaining Amount");
        VendLedgEntry2.CalcFields("Original Amount");
        PostingDesc := VendLedgEntry2.Description;
        OriginalAmount := ABS(VendLedgEntry2."Original Amount");

        OriginalAmount := Round(
                    ExchangeAmt(VendLedgEntry2."Posting Date", CurrencyCode2, GenJnlLine."Currency Code",
                      OriginalAmount), Currency."Amount Rounding Precision");
        GetRemainingAmount := ABS(VendLedgEntry2."Remaining Amount");
        ...
        TypeText := Format(VendLedgEntry2."Document Type");
    ...
    begin
        ...
        CheckDateDt := EmployeeLedgerEntry2."Posting Date";
        PostingDesc := EmployeeLedgerEntry2.Description;
        EmployeeLedgerEntry2.CalcFields("Original Amount");
        OriginalAmount := ABS(EmployeeLedgerEntry2."Original Amount");

        OriginalAmount := Round(
                         ExchangeAmt(EmployeeLedgerEntry2."Posting Date", CurrencyCode2, GenJnlLine."Currency Code",
                           OriginalAmount), Currency."Amount Rounding Precision");
        GetRemainingAmount := ABS(EmployeeLedgerEntry2."Remaining Amount");
        ...
        LineAmount2 :=
          Round(
            ...
            Currency."Amount Rounding Precision");
        TypeText := Format(EmployeeLedgerEntry2."Document Type");
        if (EmployeeLedgerEntry2."Document Type" = EmployeeLedgerEntry2."Document Type"::Invoice) then begin
            TypeText := Format('Bill');
        end;
    ...
    procedure SetDescription(var DescriptionGiven: Text[250])
    begin

        Description := DescriptionGiven;
    end;

    procedure SetTmpTable(var TmpTableGiven: Record TmpTable)
    begin

        TmpTable := TmpTableGiven;
    end;

    procedure SetVoidGenJnlLine(var GivenGenJnlLine: Record "Gen. Journal Line")
    begin

        VoidGenJnlLine := GivenGenJnlLine;
    end;
