table 50036 TmpCommission
{
    Caption = 'TmpCommission';
    ...
    keys
    {
        key(PK; UserId, CustNo, "Type", "DatePaid", InvoiceNo, ItemNo, License, SubLicense)
        {
            Clustered = true;
        }
        ...
        key(IKey; UserID, Type, CustNo, InvoiceNo, License, Sublicense)
        {
