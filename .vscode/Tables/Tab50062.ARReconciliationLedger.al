table 50062 "AR Reconciliation Ledger"
{
    ...
    fields
    {
        ...
        field(7; AgedARBalanceDue; Decimal)
        {
            Caption = 'Aged AR Balance Due';
        }
    ...
    keys
    {
        key(PK; "Customer No.", "Document Type", "Document No.", SourceGLEEntryNo, "As of Date")
        {
            Clustered = true;
        }
    }
