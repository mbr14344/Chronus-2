pageextension 50065 PostedTransferReceiptsExtPage extends "Posted Transfer Receipts"
{
    layout
    {
        addfirst(factboxes)
        {
            ...
            part("Attached Documents"; "Document Attachment Factbox")
            {
                ApplicationArea = All;
                Caption = 'Attachments';
                SubPageLink = "Table ID" = const(Database::"Transfer Receipt Header"),
                            "No." = field("No.");
            }
    ...
    var
        txtDelErr: Label 'You are NOT allowed to delete Posted Transfer Receipt %1. Please undo shipment receipt.';
