page 50071 ItemAvailabilityByEventAPI
{
    APIGroup = 'apiGroup';
    APIPublisher = 'Nutraza';
    APIVersion = 'v2.0';
    ApplicationArea = All;
    Caption = 'itemAvailabilityByEventAPI';
    DelayedInsert = true;
    EntityName = 'ItemAvailabilityByEvent';
    EntitySetName = 'ItemAvailabilityByEvent';
    PageType = API;
    SourceTable = "Inventory Page Data";
    //API endpoit : https://api.businesscentral.dynamics.com/v2.0/6f9b32a9-6801-4ab6-9dac-48098c7cb0c6/SandboxDB/api/Nutraza/Company/v2.0/ItemAvailabilityByEvent
    layout
    {
         area(content)
        {
            ...
            repeater(Control5)
            {
                ...
                field(PeriodStart; Rec."Period Start")
                {
                    ApplicationArea = Basic, Suite;
                    Editable = false;
                    Style = Strong;
                ...
                field(ReservedRequirement; Rec."Reserved Requirement")
                {
                ...
                field(ReservedReceipt; Rec."Reserved Receipt")
                {
                    ApplicationArea = Reservation;
                    Editable = false;
                    Style = Strong;
                ...
                field(ProjectedInventory; Rec."Projected Inventory")
                {
                    ApplicationArea = Basic, Suite;
                ...
                field(ForecastedProjectedInventory; Rec."Forecasted Projected Inventory")
                {
                    ApplicationArea = Basic, Suite;
                    DecimalPlaces = 0 : 5;
                    Editable = false;
                ...
                field(RemainingForecast; Rec."Remaining Forecast")
                {
                    ApplicationArea = Basic, Suite;
                    Editable = false;
                    Style = Strong;
                ...
                field(ActionMessageQty; Rec."Action Message Qty.")
                {
                    ApplicationArea = Manufacturing;
                    Editable = false;
                    Style = Strong;
                ...
                field(SuggestedProjectedInventory; Rec."Suggested Projected Inventory")
                {
                    ApplicationArea = Basic, Suite;
                    DecimalPlaces = 0 : 5;
                    Editable = false;
            ...
            group("&Item")
            {
                ...
                group("&Item Availability by")
                {
                    ...
                    action("BOM Level")
                    {
                        ...
                        trigger OnAction()
                        begin
                            // TODO: Replace with the correct method to show BOM level availability, or remove if not needed.
                            // Example: PAGE.Run(PAGE::"Item Availability by BOM Level", Item, Item."No.");
                        end;
                    }
                }
            }
    ...
    begin
        ...
        Message('using item' + format(rec.GetFilters()));
    end;
