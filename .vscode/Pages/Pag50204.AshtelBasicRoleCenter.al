page 50204 "Ashtel Basic Role Center"
{
    // CurrPage."Help And Setup List".ShowFeatured;

    Caption = 'Ashtel Basic Role Center';
    PageType = RoleCenter;
    ApplicationArea = All;
    Editable = true;
    ...
    layout
    {
        area(rolecenter)
        {
            ...
            {
                ApplicationArea = All;   // important: users must have the area enabled
                Editable = true;         // <- enables interaction (dbl-click)
                Enabled = true;          // <- belts & suspenders
