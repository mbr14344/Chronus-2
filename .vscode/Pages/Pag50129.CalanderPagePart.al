page 50129 "Calendar Page Part"
{
    PageType = CardPart;
    Caption = 'Calendar Page Part';
    RefreshOnActivate = true;
    layout
    {
        area(Content)
        {
            usercontrol("Calendar"; ad_CalendarCtrlPart)
            {
                ApplicationArea = All;
                trigger OnControlAddInReady()
                begin
                    LoadCalendarEvents();
                    //  CurrPage."Calendar".CreateCalendar(true);
                end;
                ...
                trigger Expand()
                var
                    CalendarPage: Page "Calendar Page";
                begin
